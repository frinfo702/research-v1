...
#slide()[
  ...
  #figure(image("images/Screenshot 2026-04-21 at 10.48.32.png"))
]
...
#slide()[
  ...
  #figure(image("images/proposal2.png"))
]
  ...
  #grid(
    ...
    [
      #table(
        ...
        stroke: 0.5pt + luma(200),
        inset: (x: 8pt, y: 6pt),
        table.header([Variant], [A-150 mIoU], [A-847 mIoU], [Description]),
        [Default], [], [], [],
        [w/o mask prompt forward], [], [], [],
        [w/o CLIP ensemble], [], [], [],
      )
      動かすために必要なデータセットが公式サイトから手に入らない。代替手段を探す $arrow$ 解決
      #figure(image("images/not_found_error.png"))
      必要なデータセットが抜けていた
    ],
    [
      #figure(
